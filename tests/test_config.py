...
from helios.utils.config import Settings, get_settings, load_settings
...
class TestSettings:
    ...
    def test_settings_all_from_environment(self):
...
class TestGetSettings:
    ...
    def test_get_settings_missing_required(self):
...
class TestLoadSettings:
    ...
    @patch.dict(os.environ, {"OPENROUTER_API_KEY": "test-key"}, clear=True)
    def test_load_settings_caches_instance(self):
    ...
    @patch.dict(os.environ, {"OPENROUTER_API_KEY": "test-key"}, clear=True)
    def test_load_settings_singleton_behavior(self):
